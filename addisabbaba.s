...
; pc  447c  sp  3038  sr  0000  cg  0000
; r04 0000  r05 5a08  r06 0000  r07 0000
; r08 0000  r09 0000  r10 0000  r11 303c
; r12 0000  r13 304f  r14 007d  r15 0000

; 3020:   2000 2000 4446 0000 4c45 0100 ce44 7d00    . .DF..LE...D}.
; 3030:   0024 3430 0024 0000 3c30 0000 3031 3233   .$40.$..<0..0123
; 3040:   3435 3637 3839 6162 6364 6566 6768 6900   456789abcdefghi.

; %x%xABCDEFG%x%x%x%x --> 7825ABCDEFG7825424144434645
;                     str  x %        x % B A D C F E

; blat instr @ 448e
; 8e44256e              - NOPE: writes 0002 to &0000
; 8e44257825782578256e  - NOPE: dies trying to write 000a to &7825 (misaligned)
; 25788e4425788e44256e  - YESSSS (could probs be shorter...)
...
; // count % codes
45e8:  0b3c           jmp	test_eos <printf+0x38>
...
4656:  333c           jmp	#0x46be <printf+0xf6>x
