...
; pwd is strictly alphanumeric. anything past 1st non AN char is wiped
...
;
; vectors:
;   password can be 0x200 bytes long
;       starting at 43ed
;   call <INT> available at  4656  "VF":
;       4656:  b012 fc45      call	#0x45fc <INT>
;
;
;
;   3243           mov 	#-0x1, sr
;       KHAAAAAAN  CPUOFF flag set; program no longer running. CPU must now be reset.
;   4243           clr.b 	sr
;   3051           ret
;
;   7a 4142 4344 4546 4748 3243 4243 3051
...
; 7a 3030 3131 3232 3333 3434 3535 3636 3737 3044 5646 4242 4343 4444 4545 4646 4747 4848 6161 6262 6363 6464 6565 6666 6767 68686161 6262 6363 6464 6565 6666 6767 6868 5843 4e58 4f6e 3041

;   7863           addc.b 	#-0x1, r8
;   4f68           addc.b 	r8, r15
;   3041           ret

; 7a 3030 3131 3232 3333 3434 3535 3636 3737 3044 5646 4242 4343 4444 4545 4646 4747 4848 6161 6262 6363 6464 6565 6666 6767 68686161 6262 6363 6464 6565 6666 6767 6868 7863 4f68 3041
...
; char c = gbuf[0]
; int i<r14> = 0
; const MAX_DIGIT_OFFS = 9
; const MAX_ALPHA_OFFS = 25
...
45b0:  7b50 d0ff      add.b	#0xffd0, r11    ; r11 -= 48
45b4:  4c9b           cmp.b	r11, r12
45b6:  f42f           jc	#0x45a0 <login+0x42>   ; jge

;   c -= 17
;   if( c <= 25 ) continue;
45b8:  7b50 efff      add.b	#0xffef, r11        ; r11 -= 17
45bc:  4d9b           cmp.b	r11, r13
45be:  f02f           jc	#0x45a0 <login+0x42>

;   c -= 32
;   if( c <= 25 ) continue;
45c0:  7b50 e0ff      add.b	#0xffe0, r11        ; r11 -= 32
...
469a:  082c           jc	#0x46ac <memset+0x20>
469c:  043c           jmp	#0x46a6 <memset+0x1a>
469e:  cb4e 0000      mov.b	r14, 0x0(r11)
46a2:  1b53           inc	r11
46a4:  3d53           add	#-0x1, r13
46a6:  0d93           tst	r13
46a8:  fa23           jnz	#0x469e <memset+0x12>
46aa:  1e3c           jmp	#0x46e8 <memset+0x5c>
46ac:  4a4e           mov.b	r14, r10
46ae:  0a93           tst	r10
46b0:  0324           jz	#0x46b8 <memset+0x2c>
46b2:  0c4a           mov	r10, r12
46b4:  8c10           swpb	r12
46b6:  0adc           bis	r12, r10
46b8:  1fb3           bit	#0x1, r15
46ba:  0524           jz	#0x46c6 <memset+0x3a>
